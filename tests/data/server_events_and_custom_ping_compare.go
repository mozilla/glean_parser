...
// buildPayload assembles the inner pingPayload for `events`. Shared by
// the logging and pub/sub code paths.
func (p EventsPing) buildPayload(appDisplayVersion, appChannel string) pingPayload {
...
func (g GleanEventsLogger) RecordEventsPing(
    ...
    return g.record("events", documentID, requestInfo, payload)
}
